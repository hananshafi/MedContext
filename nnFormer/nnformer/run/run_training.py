...
def main():
    ...
    #                       nnFormerTrainer) or issubclass(trainer_class, nnFormerTrainer_synapse) or issubclass(trainer_class, nnFormerTrainer_synapse) , "network_trainer was found but is not derived from nnFormerTrainer"
