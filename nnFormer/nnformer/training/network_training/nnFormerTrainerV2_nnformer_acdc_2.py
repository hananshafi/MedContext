...
from nnformer.network_architecture.nnFormer_acdc_2 import nnFormer
...
from nnformer.training.network_training.nnFormerTrainer_2 import nnFormerTrainer
...
class nnFormerTrainerV2_nnformer_acdc_2(nnFormerTrainer):
    """
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits[self.fold]['train'] = ['patient001_frame12', 'patient004_frame15','patient005_frame01','patient013_frame14', 'patient043_frame07']
