...
def test(fold):
    path='/l/users/hanan.ghani/nnFormer/'
    label_list=sorted(glob.glob(os.path.join('/l/users/hanan.ghani/unetr_plus_plus/UNETR_PP_DATASETS/DATASET/unetr_pp_raw/unetr_pp_raw_data/Task001_ACDC/val_labels','*nii.gz')))
    infer_list=sorted(glob.glob(os.path.join(path,'output_acdc_student_teacher_weight05_mask06_normMSEMasked_4losses/nnFormer/3d_fullres/Task001_ACDC/nnFormerTrainerV2_nnformer_acdc_2__nnFormerPlansv2.1/fold_0/validation_raw_best','*nii.gz')))
